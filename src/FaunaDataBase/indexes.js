...
module.exports = {
  ...
  GET_STUDENT_COURSE_PRESENCE_MODULE1_BY_EMAIL: 'get_student_course_presence_module1_by_email',
  ...
  GET_STUDENT_COURSE_PRESENCE_MODULE1_BY_NAME: 'get_student_course_presence_module1_by_name',
  GET_STUDENTS_BY_YEAR_MONTH: 'get_students_by_year_month',
  GET_COURSE_PRESENCE_BY_TITLE: 'get_course_presence_by_title'
}