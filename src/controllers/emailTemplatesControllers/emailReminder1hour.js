...
const fs = require('fs');
const emailSubjectJSON = require('../../Nodemailer/EmailReminder1hour/emailSubject.json');
  ...
  jwt.verify(
    ...
    async (err, data) => {
      if (err) {
        ...
        try {
          const localJSONpath = path.join(__dirname, '../../Nodemailer/EmailReminder1hour/emailSubject.json')
